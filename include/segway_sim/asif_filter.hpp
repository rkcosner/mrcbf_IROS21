...
static const double x_obstacle[npSS] = {1};
double xBound[npSS] = {.5};
static const double xBoundBackup[nx] = {1.,.5,M_PI/6,0.5};
// static const double xBoundBackup[nx] = {.25,.1,M_PI/6,.5};
double centerBackup[nx] = {0.,0.,0.138324423615,0.};
...
static const double P[nx*nx] = {0.172876394755142,0.119208421050953,0.209954019944465,0.0745807754201193,0.119208421050953,0.149139321430469,0.277644386579805,0.0955344340520715,0.209954019944465,0.277644386579805,0.612151922126010,0.188111856080657,0.0745807754201193,0.0955344340520715,0.188111856080657,0.0658323616883793};
static const double mPpPt[nx*nx] = {-0.238416842101906,-0.419908039888931,-0.149161550840239,-0.238416842101906,-0.298278642860938,-0.555288773159610,-0.191068868104143,-0.419908039888931,-0.555288773159610,-1.22430384425202,-0.376223712161314,-0.149161550840239,-0.191068868104143,-0.376223712161314,-0.131664723376759};


static const double Pv = 5e-2;

static const double K[nx] = {0*31.6228, 53.8663, 166.1565, 64.2677};//{s*44.7214, 1*44.6528, 150.1612, 1*37.6492;
...
static const double model[15] = {44.798,            //mb
                                 ...
                                 1.0e-3,            //velEps
                                 0//1.225479467549329  //FricCoeff 1.225479467549329
                                 };
...
//     0.5,               //L
//     9.81,              //gGravity
//     0.0,                //FricCoeff 3.185188257847262
//     1.0e-3,            //velEps
...
void safetySet(const double x[nx], double h[npSS], double Dh[npSS*nx])
{
	...
	// if (x_obstacle[0] - x[0] > xBound[0])
	// 	xLin[0] = 0;
	// else
	// 	xLin[0] = xBound[0] - (x_obstacle[0] - x[0]);
